import { InputEventSanitized, SessionChar, SessionCharsIndex, SessionState } from '../models/session.types';
import {
  currentSessionChar,
  isCorrect,
  moveBackwardFrom,
...
import { exists, isNewline, isSpace, isUndefined, isWord } from '../../../common/functions/common.functions';
